...
export class CreateProductResponse extends SdkResponse {
    ...
    public withAppId(appId: string): CreateProductResponse {
        this['app_id'] = appId;
        return this;
    }
    ...
    public withAppName(appName: string): CreateProductResponse {
    ...
    public withName(name: string): CreateProductResponse {
        this['name'] = name;
        return this;
    }
    public withDeviceType(deviceType: string): CreateProductResponse {
    ...
    public withProtocolType(protocolType: string): CreateProductResponse {
    ...
    public withDataFormat(dataFormat: string): CreateProductResponse {
    ...
    public withManufacturerName(manufacturerName: string): CreateProductResponse {
    ...
    public withIndustry(industry: string): CreateProductResponse {
        this['industry'] = industry;
        return this;
    }
    public withDescription(description: string): CreateProductResponse {
        this['description'] = description;
        return this;
    }
    public withServiceCapabilities(serviceCapabilities: Array<ServiceCapability>): CreateProductResponse {
    ...
    public withCreateTime(createTime: string): CreateProductResponse {
