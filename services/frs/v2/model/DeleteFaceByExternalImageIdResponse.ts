...
export class DeleteFaceByExternalImageIdResponse extends SdkResponse {
    ...
    public withFaceNumber(faceNumber: number): DeleteFaceByExternalImageIdResponse {
    ...
    public withFaceSetId(faceSetId: string): DeleteFaceByExternalImageIdResponse {
    ...
    public withFaceSetName(faceSetName: string): DeleteFaceByExternalImageIdResponse {
