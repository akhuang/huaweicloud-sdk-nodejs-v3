...
export class ShowFunctionAsyncInvokeConfigResponse extends SdkResponse {
    ...
    public withFuncUrn(funcUrn: string): ShowFunctionAsyncInvokeConfigResponse {
    ...
    public withMaxAsyncEventAgeInSeconds(maxAsyncEventAgeInSeconds: number): ShowFunctionAsyncInvokeConfigResponse {
    ...
    public withMaxAsyncRetryAttempts(maxAsyncRetryAttempts: number): ShowFunctionAsyncInvokeConfigResponse {
    ...
    public withDestinationConfig(destinationConfig: FuncAsyncDestinationConfig): ShowFunctionAsyncInvokeConfigResponse {
    ...
    public withCreatedTime(createdTime: string): ShowFunctionAsyncInvokeConfigResponse {
    ...
    public withLastModified(lastModified: string): ShowFunctionAsyncInvokeConfigResponse {
    ...
    public withEnableAsyncStatusLog(enableAsyncStatusLog: boolean): ShowFunctionAsyncInvokeConfigResponse {
