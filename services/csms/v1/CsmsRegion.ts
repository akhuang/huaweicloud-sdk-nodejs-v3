...
export class CsmsRegion {
    ...
    private static REGION_MAP: RegionMap = {
        "cn-north-4":CsmsRegion.CN_NORTH_4,
        "cn-north-1":CsmsRegion.CN_NORTH_1,
        "cn-north-2":CsmsRegion.CN_NORTH_2,
        "cn-east-2":CsmsRegion.CN_EAST_2,
        "cn-east-3":CsmsRegion.CN_EAST_3,
        "cn-south-1":CsmsRegion.CN_SOUTH_1,
        "cn-southwest-2":CsmsRegion.CN_SOUTHWEST_2,
        "ap-southeast-1":CsmsRegion.AP_SOUTHEAST_1,
        "ap-southeast-3":CsmsRegion.AP_SOUTHEAST_3,
        "la-south-2":CsmsRegion.LA_SOUTH_2,
        "sa-brazil-1":CsmsRegion.SA_BRAZIL_1,
        "la-north-2":CsmsRegion.LA_NORTH_2,
        "ap-southeast-2":CsmsRegion.AP_SOUTHEAST_2
    };
