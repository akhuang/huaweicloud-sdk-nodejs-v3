...
export class UpdateSubNetworkInterfaceResponse extends SdkResponse {
    private 'request_id'?: string | undefined;
    private 'sub_network_interface'?: SubNetworkInterface | undefined;
    public constructor() { 
        super();
    }
    public withRequestId(requestId: string): UpdateSubNetworkInterfaceResponse {
    ...
    public withSubNetworkInterface(subNetworkInterface: SubNetworkInterface): UpdateSubNetworkInterfaceResponse {
